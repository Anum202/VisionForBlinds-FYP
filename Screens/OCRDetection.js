...
const OCRDetection = ({navigation}) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      ToastAndroid.show("Extracting text from image !", ToastAndroid.SHORT);

      try {
        const response = await fetch('http:192.168.100.12:8000/ocrapi', {
          method: 'post',
          body: formData,
          headers: {},
        });
          ...
          >
            ...
            >
              <View style={styles.modalContent}>
                <Text style={styles.captionHead}>{`Extracted text from image is:`}</Text>
